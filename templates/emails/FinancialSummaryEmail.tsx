...
interface FinancialSummaryEmailProps {
  logoUrl: string;
  fullname: string;
}

export const FinancialSummaryEmail = ({
  logoUrl,
  fullname,
}: FinancialSummaryEmailProps) => (
  <Html>
    <Head />
    <Body style={main}>
...
FinancialSummaryEmail.PreviewProps = {
  logoUrl:
    "https://www.centraalinning.com/wp-content/uploads/2020/06/CI-Logo-Orange.png",
  fullname: "Alan",
} as FinancialSummaryEmailProps;

export default FinancialSummaryEmail;
