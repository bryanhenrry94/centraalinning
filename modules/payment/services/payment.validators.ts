...
export const enum PaymentType {
  ...
  GOP = "GOP",
  GOP_ACTIVATION = "GOP_ACTIVATION",
  GOP_TRANSFER = "GOP_TRANSFER",
  GOP_LAWYER_FEE = "GOP_LAWYER_FEE",
  GOP_BAILIFF_FEE = "GOP_BAILIFF_FEE",
  FAR_REGISTRATION = "FAR_REGISTRATION",
  COP_START = "COP_START",
  DEBTOR_COLLECTION_FEE = "DEBTOR_COLLECTION_FEE",
  OTHER = "OTHER",
}
...
const PaymentTypeEnum = z.enum([
  ...
  PaymentType.GOP,
  PaymentType.GOP_ACTIVATION,
  PaymentType.GOP_TRANSFER,
  PaymentType.GOP_LAWYER_FEE,
  PaymentType.GOP_BAILIFF_FEE,
  PaymentType.FAR_REGISTRATION,
  PaymentType.COP_START,
  PaymentType.DEBTOR_COLLECTION_FEE,
  PaymentType.OTHER,
]);
