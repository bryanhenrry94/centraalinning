...
import { createGopAgreement } from "@/modules/legal-process/actions/legal-process.actions";
...
export const CreateAgreementDialog: React.FC<CreateAgreementDialogProps> = ({
  ...
  const handleSubmit = async () => {
    ...
    setLoading(true);
    try {
      await createGopAgreement(legalProcessId, {
      ...
      notifySuccess("Betalingsregeling geregistreerd, in afwachting van goedkeuring");
      onRegistered();
      handleClose();
    } catch (error) {
  ...
  return (
    <Dialog open={open} onClose={handleClose} maxWidth="xs" fullWidth>
      <DialogTitle>Betalingsregeling registreren</DialogTitle>
      <DialogContent>
