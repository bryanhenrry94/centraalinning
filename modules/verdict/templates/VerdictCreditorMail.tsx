...
interface VerdictCreditorMailProps {
  logoUrl: string;
  link: string;
}

export const VerdictCreditorMail = ({
  logoUrl,
  link,
}: VerdictCreditorMailProps) => (
  <Html>
    <Head />
    <Body style={main}>
