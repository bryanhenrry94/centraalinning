      ...
      <section className="space-y-8">
        <div>
          ...
          <p className="text-justify">
            ...
            gebruik van het Platform te staken. Het gebruik van het Platform is
            enkel toegestaan voor personen ouder dan 18 jaar of die voldoen aan
            de wettelijke leeftijdsvereisten in hun rechtsgebied.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="text-justify">
            De Gebruiker verbindt zich ertoe het Platform uitsluitend te
            gebruiken voor legitieme zakelijke doeleinden en in overeenstemming
            met alle toepasselijke wetten. Het is verboden het Platform te
            gebruiken voor frauduleuze activiteiten, het verstoren van de
            werking of het proberen te verkrijgen van ongeoorloofde toegang tot
            systemen of gegevens.
          </p>
        </div>

        <div>
          <h2 className="text-xl font-semibold mb-2">3. Accountregistratie</h2>
          <p className="text-justify">
            Bepaalde functies vereisen een gebruikersaccount. De Gebruiker is
            verantwoordelijk voor de vertrouwelijkheid van zijn inloggegevens en
            alle activiteiten die plaatsvinden onder zijn account. De Gebruiker
            garandeert dat alle verstrekte informatie accuraat, volledig en
            actueel is.
          </p>
        </div>
        ...
        <div>
          <h2 className="text-xl font-semibold mb-2">
            5. Geautomatiseerde Communicatie en Kennisgevingen
          </h2>
          <p className="text-justify">
            Het Platform verzendt automatisch meldingen, herinneringen en
        ...
        <div>
          <h2 className="text-xl font-semibold mb-2">
            6. Geautomatiseerde Acties en Processen
          </h2>
          <p className="text-justify">
            Het Platform kan automatisch acties uitvoeren, zoals het bijwerken
            van statussen, het genereren van rapporten of het verzenden van
            betalingsherinneringen. Deze automatiseringen worden uitgevoerd
            volgens vooraf ingestelde configuraties of de instellingen van de
            Gebruiker. De Gebruiker blijft verantwoordelijk voor het controleren
            van deze acties en de juistheid van de ingevoerde gegevens.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="text-justify">
            ...
            passende wijze aan de Gebruiker worden meegedeeld.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="text-justify">
            Op deze Algemene Voorwaarden is het recht van Nederland van
            toepassing. Eventuele geschillen die voortvloeien uit of verband
            houden met het gebruik van het Platform zullen exclusief worden
